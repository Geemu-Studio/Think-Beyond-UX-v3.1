...
const STATS = [
  { value: '35,000', label: 'Individual Journeys Unified' },
  { value: '62%', label: 'Reduction in Administrative Friction' },
  { value: '17,500', label: 'Seamless Enrolment Experiences' },
];
      ...
      <div className="mx-auto max-w-4xl flex flex-col gap-10">
        ...
        <div className="bg-white rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-8 sm:p-12 flex flex-col gap-8">
          ...
          <h3 className="text-[22px] sm:text-[28px] leading-[1.2] tracking-[-0.8px] text-black" style={{ fontWeight: 700 }}>
            35,000 individual journeys, one unified experience.
          </h3>

          {/* Body */}
          <p className="text-[15px] text-neutral-500 leading-[1.75] max-w-xl">
            See how SWPS University revolutionised its admissions architecture, turning complex data into deeply personalised candidate experiences during peak enrolment periods.
          </p>
          ...
          <div>
            ...
            >
              Explore the SWPS Success Story →
            </a>
          </div>
