...
const STATS = [
  { value: '17,500', label: 'Lifelong Relationships' },
      ...
      <div className="mx-auto max-w-4xl flex flex-col gap-10">
        ...
        <div className="bg-white rounded-[24px] shadow-[0_4px_24px_rgba(0,0,0,0.06)] p-8 sm:p-12 flex flex-col gap-8">
          ...
          <h3 className="text-[22px] sm:text-[28px] leading-[1.2] tracking-[-0.8px] text-black" style={{ fontWeight: 700 }}>
            17,500 lifelong relationships, one connected alumni community.
          </h3>

          {/* Body */}
          <p className="text-[15px] text-neutral-500 leading-[1.75] max-w-xl">
            Discover how SWPS University transformed its alumni engagement, turning fragmented data into a cohesive network that drives continuous learning and institutional pride.
          </p>
          ...
          <div>
            ...
            >
              Discover the SWPS Alumni Story →
            </a>
          </div>
